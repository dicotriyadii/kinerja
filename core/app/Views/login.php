...
<head>
  ...
  <title>Login - KINERJA TIKSAN</title>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Login Menggunakan Akun Anda</h5>
                    <p class="text-center small">Masukkan NIK dan Password Anda</p>
                  </div>
                  <form class="row g-3 needs-validation" method="POST" action="Login_">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <div class="col-12" style="text-align:right;margin-top:5px;">
                        <a href="<?=base_url()?>/BukuTamu" >Buku Tamu</a>
                      </div>
                  </form>
