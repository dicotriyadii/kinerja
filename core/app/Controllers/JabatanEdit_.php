...
class JabatanEdit_ extends ResourceController
{
    use ResponseTrait;
    public function create()
    {
        ...
        $idMasterJabatan    = $this->request->getPost('idMasterJabatan');
        $namaJabatan        = $this->request->getPost('namaJabatan');
        // proses API Login
        $curl = curl_init();
        curl_setopt_array($curl, array(
        CURLOPT_URL =>'https://kominfostan.deliserdangkab.go.id/APIHaloKominfoInternal/api/EditJabatan/'.$idMasterJabatan,
