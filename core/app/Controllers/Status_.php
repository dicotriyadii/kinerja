...
class Status_ extends ResourceController
{
    use ResponseTrait;
    public function create()
    {
        ...
        CURLOPT_URL =>'https://kominfostan.deliserdangkab.go.id/APIHaloKominfoInternal/api/TambahStatus',
    ...
    public function hapus($id=null)
    {
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
        CURLOPT_URL =>'https://kominfostan.deliserdangkab.go.id/APIHaloKominfoInternal/api/HapusStatus/'.$id.'/'.$idPegawaiAkses,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
